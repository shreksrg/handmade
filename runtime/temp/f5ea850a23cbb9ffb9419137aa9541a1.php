<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:68:"/var/webstars/handmade/addons/ldcms/view/ldcms2024/list_product.html";i:1716893402;s:62:"/var/webstars/handmade/addons/ldcms/view/ldcms2024/common.html";i:1716869348;s:60:"/var/webstars/handmade/addons/ldcms/view/ldcms2024/head.html";i:1726207716;s:65:"/var/webstars/handmade/addons/ldcms/view/ldcms2024/neibanner.html";i:1708573732;s:64:"/var/webstars/handmade/addons/ldcms/view/ldcms2024/neiernav.html";i:1709276850;s:64:"/var/webstars/handmade/addons/ldcms/view/ldcms2024/footmess.html";i:1709803868;s:60:"/var/webstars/handmade/addons/ldcms/view/ldcms2024/foot.html";i:1721655678;s:62:"/var/webstars/handmade/addons/ldcms/view/ldcms2024/footjs.html";i:1709304090;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
            ...
            <div class="head_r flexrow">
              <div class="nav">
                <ul class="flexrow">
                  ...
                  <?php $__dc50oQ4zpB__ =\addons\ldcms\model\Category::instance()->getHomeNav(0,"");if(is_array($__dc50oQ4zpB__) || $__dc50oQ4zpB__ instanceof \think\Collection || $__dc50oQ4zpB__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__dc50oQ4zpB__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;$item["image"]=cdnurl($item["image"],true);$item["big_image"]=cdnurl($item["big_image"],true);?>
                  <li class="<?php if($topid==$item['id']): ?> active <?php endif; ?>">
                        ...
                        <div class="ernavitem flexrow">
                          <div class="ernav_l">
                            ...
                            <ul class="ernavlink flexrow">
                              <?php $__nVBxgwQpH2__ =\addons\ldcms\model\Category::instance()->getHomeNav($item['id'],"");if(is_array($__nVBxgwQpH2__) || $__nVBxgwQpH2__ instanceof \think\Collection || $__nVBxgwQpH2__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__nVBxgwQpH2__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav2): $mod = ($i % 2 );++$i;$nav2["image"]=cdnurl($nav2["image"],true);$nav2["big_image"]=cdnurl($nav2["big_image"],true);?>
                              <li>
                ...
                <div class="con1400">
                  ...
                  <div class="wapnavbot">
                    <ul>
                      ...
                      <?php $__qQ1MBLpOiT__ =\addons\ldcms\model\Category::instance()->getHomeNav(0,"");if(is_array($__qQ1MBLpOiT__) || $__qQ1MBLpOiT__ instanceof \think\Collection || $__qQ1MBLpOiT__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__qQ1MBLpOiT__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;$item["image"]=cdnurl($item["image"],true);$item["big_image"]=cdnurl($item["big_image"],true);?>
                      <li class="flexrow">
                        ...
                        <div class="wapernav">
                          <?php $__pMahRctexL__ =\addons\ldcms\model\Category::instance()->getHomeNav($item['id'],"");if(is_array($__pMahRctexL__) || $__pMahRctexL__ instanceof \think\Collection || $__pMahRctexL__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__pMahRctexL__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav2): $mod = ($i % 2 );++$i;$nav2["image"]=cdnurl($nav2["image"],true);$nav2["big_image"]=cdnurl($nav2["big_image"],true);?>
                          <a href="<?php echo $nav2['url']; ?>"
                            title="<?php echo $nav2['name']; ?>"><?php echo $nav2['name']; ?></a>
                          <?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
  ...
  <!-- banner -->
  <div class="banner">
      <?php $__4Mkc6tewZv__ =\addons\ldcms\model\Category::instance()->getHomeCategory($topid,0,"");$__4Mkc6tewZv__=[$__4Mkc6tewZv__];if(is_array($__4Mkc6tewZv__) || $__4Mkc6tewZv__ instanceof \think\Collection || $__4Mkc6tewZv__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__4Mkc6tewZv__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
      <div class="neibanner">
  ...
  <section class="neinav">
    <div class="con1400">
      <div class="neinav_item flexrow">
          <ul class="flexrow">
            <?php $__xuZVA6Q03I__ =\addons\ldcms\model\Category::instance()->getHomeNav($topid,"");if(is_array($__xuZVA6Q03I__) || $__xuZVA6Q03I__ instanceof \think\Collection || $__xuZVA6Q03I__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__xuZVA6Q03I__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;$item["image"]=cdnurl($item["image"],true);$item["big_image"]=cdnurl($item["big_image"],true);?>
          ...
          <div class="casetop_r">
            <p>
              ...
              <?php $__eXbmwfnQ5V__=\addons\ldcms\model\Category::instance()->getHomePosition($category['id']);if(is_array($__eXbmwfnQ5V__) || $__eXbmwfnQ5V__ instanceof \think\Collection || $__eXbmwfnQ5V__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__eXbmwfnQ5V__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
              >
              <a href="<?php echo $item['url']; ?>"><?php echo $item['name']; ?></a> 
              <?php endforeach; endif; else: echo "" ;endif; ?>
            </p>
      ...
      <div class="con1400">
        <div class="prolist_item flexrow">
          <div class="prolist_l animate" data-animate="fadeInLeft" data-duration="1.5s" data-delay="0.1s">
            <div class="prolist_lnav">
              ...
              <div class="prolist_ltop flexrow">
                <?php $__4zr5kD8LOd__ =\addons\ldcms\model\Category::instance()->getHomeCategory($topid,0,"");$__4zr5kD8LOd__=[$__4zr5kD8LOd__];if(is_array($__4zr5kD8LOd__) || $__4zr5kD8LOd__ instanceof \think\Collection || $__4zr5kD8LOd__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__4zr5kD8LOd__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                <h2><?php echo $item['name']; ?></h2>
                <?php endforeach; endif; else: echo "" ;endif; ?>
              </div>
              ...
              <div class="prolist_lbot">
                <ul>
                  <?php $__qiJfGYd2SK__=\addons\ldcms\model\Fields::instance()->getHomeFilter($category['mid'],"全部");if(is_array($__qiJfGYd2SK__['filterList']) || $__qiJfGYd2SK__['filterList'] instanceof \think\Collection || $__qiJfGYd2SK__['filterList'] instanceof \think\Paginator): $i = 0; $__LIST__ = $__qiJfGYd2SK__['filterList'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                  <li>
                    <div class="pronav1">
                    ...
                    <div class="erpronav   <?php if($category['id']==$item['id']): ?> active <?php endif; ?>">
                      <ul>
                        ...
                        <li>
                          <a class="flexrow" href="<?php echo $li['url']; ?>">
                            <span class="<?php echo !empty($li['active'])?'active':''; ?>"><?php echo __($li['title']); ?></span>
                  ...
                  <?php endforeach; endif; else: echo "" ;endif; $filterWhere=$__qiJfGYd2SK__["filterWhere"];?>
                </ul>
              </div>
            </div>
            <script>
          ...
          <div class="prolist_r animate" data-animate="fadeInRight" data-duration="1.5s" data-delay="0.1s">
            ...
            is_null($simple)&&$addon_config['simple']&&request()->isMobile()?$simple=true:'';$__cZ5ExJv6bi__=\addons\ldcms\model\Document::instance()->getHomeList(['cid'=>$cid,'mid'=>$mid,'limit'=>'12','ext'=>'content','filterWhere'=>isset($filterWhere)?$filterWhere:[],'_where'=>isset($_where)?$_where:[],'page'=>$page,'simple'=>$simple,'_order'=>'']); if(is_array($__cZ5ExJv6bi__) || $__cZ5ExJv6bi__ instanceof \think\Collection || $__cZ5ExJv6bi__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__cZ5ExJv6bi__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                <li class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                  <a href="<?php echo $item['url']; ?>" title="<?php echo $item['title']; ?>">
                    ...
                    <div class="prolist_item_text">
                      ...
                      <p><?php echo ld_str_cut($item['seo_description'] ?? '',30); ?></p>
                    </div>
                  </a>
                </li>
                <?php endforeach; endif; else: echo "" ;endif; $pages=$page?$__cZ5ExJv6bi__->render():"";$pages_total=$page&&!$simple?$__cZ5ExJv6bi__->total():0; ?>
              </ul>
            </div>
            <div class="newspage">
              <?php echo $pages; ?>
...
data-animate="fadeInUp" data-duration="1.5s" data-delay="0.1s">
      <div class="con1400">
        <?php $__LF8Ewn9UC6__ =\addons\ldcms\model\Category::instance()->getHomeCategory(162,0,"");$__LF8Ewn9UC6__=[$__LF8Ewn9UC6__];if(is_array($__LF8Ewn9UC6__) || $__LF8Ewn9UC6__ instanceof \think\Collection || $__LF8Ewn9UC6__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LF8Ewn9UC6__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
      ...
      <div class="con1400">
        ...
        <div class="footmid flexrow">
          <div class="footmid_l flexrow">
            <?php $__8xJ2Kqv03H__ =\addons\ldcms\model\Category::instance()->getHomeNav(0,"");if(is_array($__8xJ2Kqv03H__) || $__8xJ2Kqv03H__ instanceof \think\Collection || $__8xJ2Kqv03H__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__8xJ2Kqv03H__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;$item["image"]=cdnurl($item["image"],true);$item["big_image"]=cdnurl($item["big_image"],true);?>
            <dl>
              <dt><a href="<?php echo $item['url']; ?>"
                  title="<?php echo $item['name']; ?>"><?php echo $item['name']; ?></a></dt>
              <?php $__WHXoSvujJz__ =\addons\ldcms\model\Category::instance()->getHomeNav($item['id'],"");if(is_array($__WHXoSvujJz__) || $__WHXoSvujJz__ instanceof \think\Collection || $__WHXoSvujJz__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__WHXoSvujJz__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav2): $mod = ($i % 2 );++$i;$nav2["image"]=cdnurl($nav2["image"],true);$nav2["big_image"]=cdnurl($nav2["big_image"],true);?>
        ...
        <div class="footcitem flexrow">
          <div class="footc_l">
            ...
            <span>备案号：<a href="https://beian.miit.gov.cn/"
                ...
                <?php $__KPnTteXrOy__ =\addons\ldcms\model\Category::instance()->getHomeCategory(193,0,"");$__KPnTteXrOy__=[$__KPnTteXrOy__];if(is_array($__KPnTteXrOy__) || $__KPnTteXrOy__ instanceof \think\Collection || $__KPnTteXrOy__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__KPnTteXrOy__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
              <span><a href="<?php echo $item['url']; ?>" target="_blank"><?php echo $item['name']; ?></a></span>
              <?php endforeach; endif; else: echo "" ;endif; $__xVSj81kHCb__ =\addons\ldcms\model\Category::instance()->getHomeCategory(194,0,"");$__xVSj81kHCb__=[$__xVSj81kHCb__];if(is_array($__xVSj81kHCb__) || $__xVSj81kHCb__ instanceof \think\Collection || $__xVSj81kHCb__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__xVSj81kHCb__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
              <span><a href="<?php echo $item['url']; ?>" target="_blank"><?php echo $item['name']; ?></a></span>
              <?php endforeach; endif; else: echo "" ;endif; ?>
          </div>
          <div class="footc_r">
            ...
            <div class="footc_rlinks">
              <ul>
                <?php $__0Jabn8MkZU__=\addons\ldcms\model\Links::instance()->getHomeList("link","");if(is_array($__0Jabn8MkZU__) || $__0Jabn8MkZU__ instanceof \think\Collection || $__0Jabn8MkZU__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__0Jabn8MkZU__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>

<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:65:"/var/webstars/handmade/addons/ldcms/view/ldcms2024/list_case.html";i:1716869412;s:62:"/var/webstars/handmade/addons/ldcms/view/ldcms2024/common.html";i:1716869348;s:60:"/var/webstars/handmade/addons/ldcms/view/ldcms2024/head.html";i:1726207716;s:65:"/var/webstars/handmade/addons/ldcms/view/ldcms2024/neibanner.html";i:1708573732;s:64:"/var/webstars/handmade/addons/ldcms/view/ldcms2024/neiernav.html";i:1709276850;s:64:"/var/webstars/handmade/addons/ldcms/view/ldcms2024/footmess.html";i:1709803868;s:60:"/var/webstars/handmade/addons/ldcms/view/ldcms2024/foot.html";i:1721655678;s:62:"/var/webstars/handmade/addons/ldcms/view/ldcms2024/footjs.html";i:1709304090;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
            ...
            <div class="head_r flexrow">
              <div class="nav">
                <ul class="flexrow">
                  ...
                  <?php $__8SokBv0aYC__ =\addons\ldcms\model\Category::instance()->getHomeNav(0,"");if(is_array($__8SokBv0aYC__) || $__8SokBv0aYC__ instanceof \think\Collection || $__8SokBv0aYC__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__8SokBv0aYC__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;$item["image"]=cdnurl($item["image"],true);$item["big_image"]=cdnurl($item["big_image"],true);?>
                  <li class="<?php if($topid==$item['id']): ?> active <?php endif; ?>">
                        ...
                        <div class="ernavitem flexrow">
                          <div class="ernav_l">
                            ...
                            <ul class="ernavlink flexrow">
                              <?php $__iDFIlsWt4m__ =\addons\ldcms\model\Category::instance()->getHomeNav($item['id'],"");if(is_array($__iDFIlsWt4m__) || $__iDFIlsWt4m__ instanceof \think\Collection || $__iDFIlsWt4m__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__iDFIlsWt4m__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav2): $mod = ($i % 2 );++$i;$nav2["image"]=cdnurl($nav2["image"],true);$nav2["big_image"]=cdnurl($nav2["big_image"],true);?>
                              <li>
                ...
                <div class="con1400">
                  ...
                  <div class="wapnavbot">
                    <ul>
                      ...
                      <?php $__cKz3GhCy6H__ =\addons\ldcms\model\Category::instance()->getHomeNav(0,"");if(is_array($__cKz3GhCy6H__) || $__cKz3GhCy6H__ instanceof \think\Collection || $__cKz3GhCy6H__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__cKz3GhCy6H__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;$item["image"]=cdnurl($item["image"],true);$item["big_image"]=cdnurl($item["big_image"],true);?>
                      <li class="flexrow">
                        ...
                        <div class="wapernav">
                          <?php $__7YTQl6wVO3__ =\addons\ldcms\model\Category::instance()->getHomeNav($item['id'],"");if(is_array($__7YTQl6wVO3__) || $__7YTQl6wVO3__ instanceof \think\Collection || $__7YTQl6wVO3__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__7YTQl6wVO3__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav2): $mod = ($i % 2 );++$i;$nav2["image"]=cdnurl($nav2["image"],true);$nav2["big_image"]=cdnurl($nav2["big_image"],true);?>
                          <a href="<?php echo $nav2['url']; ?>"
                            title="<?php echo $nav2['name']; ?>"><?php echo $nav2['name']; ?></a>
                          <?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
    ...
    <!-- banner -->
    <div class="banner">
        <?php $__YcjM5qUSm4__ =\addons\ldcms\model\Category::instance()->getHomeCategory($topid,0,"");$__YcjM5qUSm4__=[$__YcjM5qUSm4__];if(is_array($__YcjM5qUSm4__) || $__YcjM5qUSm4__ instanceof \think\Collection || $__YcjM5qUSm4__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__YcjM5qUSm4__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
      <div class="neibanner">
    ...
    <!-- banner end -->
         ...
         <section class="neinav">
          ...
          <ul class="flexrow">
            <?php $__7J3F9yqQiR__ =\addons\ldcms\model\Category::instance()->getHomeNav($topid,"");if(is_array($__7J3F9yqQiR__) || $__7J3F9yqQiR__ instanceof \think\Collection || $__7J3F9yqQiR__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__7J3F9yqQiR__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;$item["image"]=cdnurl($item["image"],true);$item["big_image"]=cdnurl($item["big_image"],true);?>
          ...
          <div class="casetop_r">
            <p>
              ...
              <?php $__XHKVJqxvT4__=\addons\ldcms\model\Category::instance()->getHomePosition($category['id']);if(is_array($__XHKVJqxvT4__) || $__XHKVJqxvT4__ instanceof \think\Collection || $__XHKVJqxvT4__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__XHKVJqxvT4__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
              >
              <a href="<?php echo $item['url']; ?>"><?php echo $item['name']; ?></a> 
              <?php endforeach; endif; else: echo "" ;endif; ?>
            </p>
    ...
    <section class="neimain">
      <div class="con1400">
        <div class="caselist_page">
          ...
          <?php $__oSDeIEKd1P__=\addons\ldcms\model\Fields::instance()->getHomeFilter($category['mid'],"全部");if(is_array($__oSDeIEKd1P__['filterList']) || $__oSDeIEKd1P__['filterList'] instanceof \think\Collection || $__oSDeIEKd1P__['filterList'] instanceof \think\Paginator): $i = 0; $__LIST__ = $__oSDeIEKd1P__['filterList'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
          <div class="caselistmid flexrow">
            <ul class="flexrow">
              <li><a href="javascript:;"><?php echo __($item['title']); ?>:</a></li>
              ...
              <li class="<?php echo !empty($li['active'])?'active':''; ?>"><a href="<?php echo $li['url']; ?>"><?php echo __($li['title']); ?></a></li>
              <?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
          ...
          <?php endforeach; endif; else: echo "" ;endif; $filterWhere=$__oSDeIEKd1P__["filterWhere"];?>

          <script>
          $(".caselistm_r").click(function(){
            $(" .caselistmid ul").toggleClass('active');
          ...
          <div class="caselist_item container">
            ...
            is_null($simple)&&$addon_config['simple']&&request()->isMobile()?$simple=true:'';$__iFztlQHTXa__=\addons\ldcms\model\Document::instance()->getHomeList(['cid'=>$cid,'mid'=>$mid,'limit'=>'6','ext'=>'content','filterWhere'=>isset($filterWhere)?$filterWhere:[],'_where'=>isset($_where)?$_where:[],'page'=>$page,'simple'=>$simple,'_order'=>'']); if(is_array($__iFztlQHTXa__) || $__iFztlQHTXa__ instanceof \think\Collection || $__iFztlQHTXa__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__iFztlQHTXa__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
              <li class="col-lg-4 col-md-4 col-sm-6 col-xs-12 animate"
              data-animate="fadeInUp" data-duration="1s" data-delay="0.1s">
                <a href="<?php echo $item['url']; ?>" title="<?php echo $item['title']; ?>">
                  ...
                  <div class="caselist_lidesc">
                    ...
                    <p><?php echo ld_str_cut($item['seo_description'] ?? '',50); ?></p>
                    <button>了解详情</button>
                  </div>
                </a>
              </li>
              <?php endforeach; endif; else: echo "" ;endif; $pages=$page?$__iFztlQHTXa__->render():"";$pages_total=$page&&!$simple?$__iFztlQHTXa__->total():0; ?>
            </ul>
          </div>
...
data-animate="fadeInUp" data-duration="1.5s" data-delay="0.1s">
      <div class="con1400">
        <?php $__2Zwzn0Rtfy__ =\addons\ldcms\model\Category::instance()->getHomeCategory(162,0,"");$__2Zwzn0Rtfy__=[$__2Zwzn0Rtfy__];if(is_array($__2Zwzn0Rtfy__) || $__2Zwzn0Rtfy__ instanceof \think\Collection || $__2Zwzn0Rtfy__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__2Zwzn0Rtfy__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
      ...
      <div class="con1400">
        ...
        <div class="footmid flexrow">
          <div class="footmid_l flexrow">
            <?php $__V8QJCSbOfa__ =\addons\ldcms\model\Category::instance()->getHomeNav(0,"");if(is_array($__V8QJCSbOfa__) || $__V8QJCSbOfa__ instanceof \think\Collection || $__V8QJCSbOfa__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__V8QJCSbOfa__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;$item["image"]=cdnurl($item["image"],true);$item["big_image"]=cdnurl($item["big_image"],true);?>
            <dl>
              <dt><a href="<?php echo $item['url']; ?>"
                  title="<?php echo $item['name']; ?>"><?php echo $item['name']; ?></a></dt>
              <?php $__zYpiuxIqy3__ =\addons\ldcms\model\Category::instance()->getHomeNav($item['id'],"");if(is_array($__zYpiuxIqy3__) || $__zYpiuxIqy3__ instanceof \think\Collection || $__zYpiuxIqy3__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__zYpiuxIqy3__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav2): $mod = ($i % 2 );++$i;$nav2["image"]=cdnurl($nav2["image"],true);$nav2["big_image"]=cdnurl($nav2["big_image"],true);?>
        ...
        <div class="footcitem flexrow">
          <div class="footc_l">
            ...
            <span>备案号：<a href="https://beian.miit.gov.cn/"
                ...
                <?php $__hxZ3Iyk8Cs__ =\addons\ldcms\model\Category::instance()->getHomeCategory(193,0,"");$__hxZ3Iyk8Cs__=[$__hxZ3Iyk8Cs__];if(is_array($__hxZ3Iyk8Cs__) || $__hxZ3Iyk8Cs__ instanceof \think\Collection || $__hxZ3Iyk8Cs__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__hxZ3Iyk8Cs__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
              <span><a href="<?php echo $item['url']; ?>" target="_blank"><?php echo $item['name']; ?></a></span>
              <?php endforeach; endif; else: echo "" ;endif; $__mg7aKZJNI4__ =\addons\ldcms\model\Category::instance()->getHomeCategory(194,0,"");$__mg7aKZJNI4__=[$__mg7aKZJNI4__];if(is_array($__mg7aKZJNI4__) || $__mg7aKZJNI4__ instanceof \think\Collection || $__mg7aKZJNI4__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__mg7aKZJNI4__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
              <span><a href="<?php echo $item['url']; ?>" target="_blank"><?php echo $item['name']; ?></a></span>
              <?php endforeach; endif; else: echo "" ;endif; ?>
          </div>
          <div class="footc_r">
            ...
            <div class="footc_rlinks">
              <ul>
                <?php $__LYGKyJxHnf__=\addons\ldcms\model\Links::instance()->getHomeList("link","");if(is_array($__LYGKyJxHnf__) || $__LYGKyJxHnf__ instanceof \think\Collection || $__LYGKyJxHnf__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LYGKyJxHnf__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
